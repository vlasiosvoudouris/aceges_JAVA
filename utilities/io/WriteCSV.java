...
public class WriteCSV {
	...
	public WriteCSV(String fileName, char delimiter, Charset charset) {
	...
	public WriteCSV(Writer outputStream, char delimiter) {
	...
	public WriteCSV(OutputStream outputStream, char delimiter, Charset charset) {
